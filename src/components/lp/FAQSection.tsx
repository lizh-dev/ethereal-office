...
const faqs = [
  ...
  {
    q: '無料で使えますか？',
    a: 'はい、ビデオ会議（4人まで）、画面共有、共有ホワイトボード、チャット・DM、集中タイマー、フロアエディターなど主要機能はすべて無料でお使いいただけます。同時接続10人まで対応しておりますので、まずはお気軽にお試しください。',
  },
  {
  ...
  {
    q: 'データはどこに保存されますか？',
    a: 'フロアのレイアウトデータはサーバーに安全に保存されます。チャットやDMの会話内容はサーバーに保存されず、リアルタイムの通信のみで処理されます。',
  },
  {
    q: '音声・ビデオ通話はできますか？',
    a: 'はい、無料プランでビデオ会議（参加者4人まで）、画面共有、共有ホワイトボードをご利用いただけます。フロアからワンクリックでミーティングを開始でき、1:1通話もメンバーリストから直接発信できます。Proプランでは参加人数・同時ミーティング数が無制限になります。',
  },
  {
    q: 'セルフホスティングとは何ですか？',
    a: 'お客様ご自身のサーバー環境にSmartOfficeを設置していただく形態です。チャット履歴を含むすべてのデータをお客様の環境内で管理でき、自社のセキュリティポリシーに沿った運用が可能です。導入については contact@smartoffice.app までお問い合わせください。',
  },
];
