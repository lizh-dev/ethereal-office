...
const comparisonRows: { feature: string; free: string | boolean; pro: string | boolean; self: string | boolean }[] = [
  { feature: 'フロア作成', free: '無制限', pro: '無制限', self: '無制限' },
  ...
  { feature: '共有ホワイトボード', free: true, pro: true, self: true },
  ...
  { feature: 'SSO', free: false, pro: true, self: true },
  { feature: 'APIアクセス', free: false, pro: true, self: true },
